...
const SekretarisLayout = ({ children }) => {
  ...
  // Data Navigasi Sesuai Input Asli Anda
  const navigation = [
    { name: 'Dashboard', href: '/sekretaris', icon: Home },
    { name: 'Jadwal Acara', href: '/sekretaris/jadwal-acara', icon: SplitSquareHorizontalIcon },
    { name: 'Dokumentasi', href: '/sekretaris/dokumentasi', icon: Camera },
    { name: 'Papan Disposisi', href: '/sekretaris/leaderboard', icon: TrendingUpIcon },
    { name: 'Daftar User', href: '/sekretaris/daftar-user', icon: UserCircle2 }
  ];
  ...
  const BrandLogo = ({ className = "" }) => (
    <div className={`flex items-center gap-3 ${className}`}>
      ...
      <div className='flex flex-col'>
        {/* Menggunakan gradient white-to-neutral sesuai referensi */}
        ...
        <div className="w-64 flex justify-end">
          <button className='flex items-center gap-3 pl-1 pr-2 py-1 rounded-full hover:bg-white/5 border border-transparent hover:border-white/5 transition-all group'>
            <div className="text-right hidden xl:block mr-1">
              <p className="text-sm font-medium text-white leading-none">Sekretaris</p>
              <p className="text-[10px] text-gray-500 mt-1">Authorized</p>
            </div>
